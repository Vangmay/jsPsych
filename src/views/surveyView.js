...
//a survey of scales
var likert_scale = ["1", "2", "3", "4", "5", "6", "7"];
...
var s3 = {
  ...
  preamble: () => {
    ...
    var pool_html = pool.map((tt) => "</br>" + tt);
    // var pool_html = pool.map((tt) => "<li>" + tt + "</li>");
    console.log(pool_html);
    var title_html = "<div>";
    title_html += ' <div class="div-upperLeft" >Here are the generated titles.';
    title_html +=
      "<div> " + pool_html.filter((x) => x != ",") + "</div> </br> </br>";
    title_html += "<b>In your opinion, they are...</b></div > ";
    title_html +=
      '<div class="div-likert-scale"><p class="p-likert-scale-0">Strongly_disagree Strongly_agree</p><p class="p-likert-scale-1">1 2 3 4 5 6 7</p></div>';
    title_html += "</div > ";
    return title_html;
  },
  questions: [
...
var s3_info = {
  ...
  questions: [
    {
      prompt:
        '<div style="width:640px;"><div class="div-error" id="error"></div>What is your age in years? Please enter a number only. <input number="number" min="0" max="100" id = "age"></div>How do you describe yourself?',
      name: "choice_gender",
...
var s3_atn = {
  ...
  questions: [
    {
      prompt:
        "Regardless of your own preferences, please select Gold to this question.<br><b>What color of iPhone would you purchase if you had to buy one tomorrow?</b>",
      name: "choice_iPhone",

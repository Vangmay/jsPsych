  ...
  if (!isSlider) {
    switch (simType) {
      ...
      case "variant":
        ...
        var sim_num = Math.floor(max_gen * 0.5);
        var dif_num = max_gen - sim_num;
        var variant = new Array(dif_num)
          .fill(0.1)
          .concat(new Array(sim_num).fill(0.5));
...
export { init_condition, get_condition, appendSimilarity, prepare_data };
